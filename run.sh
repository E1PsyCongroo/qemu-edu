...
if [[ ! -f "$script_dir/$script_dir/toolchains/qemu-longarch/loongarch64-musl-gcc-nightly-2025-3-27.tar.gz" ]]; then
...
if [[ ! -f "$script_dir/$script_dir/toolchains/qemu-virt-riscv64/riscv64gc-linux-musleabi_for_x86_64-pc-linux-gnu_latest.tar.bz2" ]]; then
